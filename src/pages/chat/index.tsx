  ...
  return (
    <div className="w-full text-center justify-center grid">
      ...
      <div className="chatWrapper grid grid-rows-6 grid-cols-6">
        <form
          action=""
          className="col-span-2 row-span-1 mt-8 border-b border-gray-200"
        >
          <input
            type="text"
            placeholder="Поиск"
            className="py-3 mx-4 px-4 border-2 border-gray-300"
        ...
        <div className="row-span-5 col-span-4 border-l chatBlock border-gray-200 grid grid-rows-6">
          ...
          <form action="" className="row-span-1 bg-white">
            <input
              ...
              className="py-3 pl-4 border-2 border-gray-300 mt-6"
              style={{
                borderRadius: "2rem",
            ...
            />
            <button
              className="bg-sky-400 p-2 text-white arrowAccept"
